...
def train_neural_network():
    ...
    save_path = "C:/Users/Jz Chai/PycharmProjects/TFexercice/Ex2/tmp2/model.ckpt"
    ...
    with tf.Session() as sess:
        ...
        if os.path.exists("C:/Users/Jz Chai/PycharmProjects/TFexercice/Ex2/tmp2/model.ckpt.index"):
        ...
        while True:
            ...
            i += 1
            s = saver.save(sess, save_path)  # 保存sessionsave_path
            print(s)
