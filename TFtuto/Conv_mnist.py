...
with tf.Session() as sess:
    ...
    path="C:/Users/JzChai~1/PycharmProjects/TFtuto/checkpoints/convnet_mnist_new"
    ...
    for index in range(initial_step, n_batches * N_EPOCHS):  # train the model n_epochs times
        ...
        if (index + 1) % SKIP_STEP == 0:
            ...
            total_loss = 0.0
            saver.save(sess, 'C:/Users/JzChai~1/PycharmProjects/TFtuto/checkpoints/convnet_mnist_new/mnist-convnet', index)
